...
function AdminViewStudent() {
  ...
  useEffect(() => {
    axios
      .get(`http://127.0.0.1:3000/viewstudent`)
      .then((res) => {
  ...
  const handleSaveClick = () => {
    axios
      .put(`http://127.0.0.1:3000/updateStudentDetail?id=${editedData.Id}`, editedData)
      .then((res) => {
  ...
  const handleViewClick = (studentId) => {
    navigate(`/admindashboard/adminviewcoursestudent?studentId=${studentId}`);
  };
